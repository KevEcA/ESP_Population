...
texts = {
    "ES": {
        ...
        "viva_header": "Cantidad de bombas vivas al final del año segregados por rangos de RL / Distribución de RL (población viva)",
        "fail_header": "Cantidad de bombas falladas al final del año segregados por rangos de RL / Distribución de RL (población fallada/censurada)",
    ...
    "EN": {
        ...
        "viva_header": "Number of active pumps at the end of the year segregated by RL ranges / RL distribution (active population)",
        "fail_header": "Number of failed pumps at the end of the year, segregated by RL ranges / RL distribution (failed/censored population)",
        "km_header": "Kaplan–Meier",
